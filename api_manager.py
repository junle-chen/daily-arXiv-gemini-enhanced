#!/usr/bin/env python
"""
API manager for filter_papers.py
"""
...
def setup_environment():
    ...
    if is_github_actions:
        print("Running in GitHub Actions environment. Configuring for optimal API usage.", file=sys.stderr)
        ...
        print("Running in local environment. Using standard API configuration.", file=sys.stderr)
        return False
